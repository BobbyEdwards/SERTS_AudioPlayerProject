...
Public Class Form1
    ...
    Dim currentSongIndex As Int32 = 0
    Dim numberOfSongs As Int32 = 0
    ...
    Private Sub Select_File_Button_Click(sender As Object, e As EventArgs) Handles Select_File_Button.Click
        ...
        If Not (File_List.SelectedIndex = -1) Then
            ...
            currentSongIndex = File_List.Items.IndexOf(File_List.SelectedItem)
            Current_Song_Label.Text = "Current Song: " + File_List.Items(currentSongIndex)
        End If
    End Sub
    ...
    Private Sub Next_Button_Click(sender As Object, e As EventArgs) Handles Next_Button.Click
        ...
        If (numberOfSongs > 0) Then
            ...
            If (currentSongIndex = numberOfSongs) Then
                currentSongIndex = 0
            End If
            SerialPort1.Write("4", 0, 1)
            SerialPort1.Write(File_List.Items(currentSongIndex))
            SerialPort1.Write(b, 0, 1) ' New Line character at the end of the string
            Current_Song_Label.Text = "Current Song: " + File_List.Items(currentSongIndex)
        End If
    End Sub
